// src/components/ModalAgregarProducto.jsx - Versión sin campo tipo
...
export function ModalAgregarProducto({ onClose, onAgregar }) {
  ...
  try {
    ...
    // Crear stock para cada sucursal (con cantidad 0)
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2 border rounded-lg"
                required
                placeholder="Ej: Chomba, Buzo de egresados, Remera deportiva"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-bold mb-1">Precio compra</label>
                <input
                  type="number"
                  name="precio_compra"
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Si no se especifica, se usará el mismo precio que efectivo
              </p>
            </div>
